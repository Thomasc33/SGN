...
def get_indices(performer, camera, evaluation='CS'):
    ...
    if evaluation == 'CS':  # Cross Subject (Subject IDs)
        train_ids = [84,24,51,12,66,58,1,56,54,62,22,42,30,64,
                     41,69,3,80,21,35,90,89,63,46,32,2,26,72,
                     50,91,16,57,36,71,31,59,78,53,9,27,7,95,
                     4,83,65,48,75,5,44,100]
        test_ids = [25,93,18,14,70,96,23,81,34,37,13,11,49,38,
                    77,74,82,88,17,19,55,99,39,20,67,85,33,28,
                    40,86,10,76,43,52,47,79,98,29,45,94,87,61,
                    97,15,8,68,6,60,73,92]
